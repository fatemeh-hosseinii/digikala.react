...
const FooterRead = () => {
    ...
    return ( <>
                <div className="w-[65%] bg-[white] flex flex-col p-2">
                    <p className="text-[22px] text-[#626161] font-semibold">فروشگاه اینترنتی دیجی‌کالا، بررسی، انتخاب و خرید آنلاین</p>
                    <div
                    ...
                    <button onClick={() => setIsExpanded(!isExpanded)} className="flex items-center mt-2">
                        <p className="text-[#45C2D3] text-[14px] ">{isExpanded ? " مشاهده کمتر" : "مشاهده بیشتر"}</p>
                    </button>
                </div>
                <div className="w-[35%] ">
                    <div className="flex flex-row justify-around  p-3">
                    {
                            Footer?.map((item,index)=>{
                               ...
                               return item.enamad_footer?.map((elem)=>{
                                    return <>
                                    <div className="flex flex-row justify-center  border-[1px] border-[#E0E0E2] w-[22%] px-2 rounded-md py-1 mx-auto">
                                        <img className="w-[70%]" src={elem.image} alt=""/>
