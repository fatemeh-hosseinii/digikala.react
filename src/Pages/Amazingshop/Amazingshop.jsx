                        ...
                        <div className=" lg:w-[50%] md:w-[45%] w-[65%] flex flex-row justify-between" >
                            ...
                            <div className=" flex lg:flex-row flex-wrap lg:gap-5 gap-3 ">
                            {
                                loading ? (
                                    ...
                                    AmazingShop?.map((elem, index) => (
                                    <div
                                        key={index}
                                        className="lg:w-[10%] w-[20%] lg:p-3 p-3 bg-[white] rounded-full relative"
                                    >
                                        <img src={elem.image} alt="" />
                                        <a
                                        href=""
                                        className="bg-[#D32F2F] rounded-full absolute right-0 bottom-0 lg:text-[12px] text-[10px] px-2 text-white"
                                        >
                                        {elem.discount}
                                        </a>
                                    </div>
