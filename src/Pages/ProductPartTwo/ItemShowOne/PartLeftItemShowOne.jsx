...
const PartLeftItemShowOne = ({ productshowone }) => {
    ...
    <>
      <div className="w-[65%]">
        ...
        <div className="flex flex-row mt-2 gap-3">
          <div className="flex flex-row gap-1">
            ...
            <p className="text-[14px] mt-1">{productshowone.rating}</p>
        ...
        <div className="p-2 flex flex-col">
          ...
          <div className="flex flex-row gap-2 flex-wrap">
            {productshowone.feature.map((elem, index) => (
      ...
      <div className="w-[45%] h-[80vh] mt-[120px] bg-[#F7F7F7] border-2 border-[#b5b5b5] rounded-lg p-3">
        ...
        <div className="bg-green mt-4 flex flex-row gap-5">
          ...
          <p className="text-[15px]">{productshowone.store}</p>
          <p className="text-[12px] text-[#00A049]">منتخب</p>
        </div>
        <div className="bg-orange mt-3 flex flex-row gap-9">
          <div className="flex flex-row gap-2">
            <p className="text-[#00A049] text-[12px]">{productshowone.pleasent}</p>
            <p className="text-[12px]">رضایت از کالا</p>
          </div>
          <div className="flex flex-row gap-2">
            <p className="text-[12px]">عملکرد</p>
            <p className="text-[#00A049] text-[12px]">{productshowone.performance}</p>
          </div>
        </div>
        ...
        <div className="flex flex-row justify-between bg-slate-400 mt-5">
          ...
          <div className="flex flex-col">
            ...
            <div>
              <p>{selectedPrice ? selectedPrice : productshowone.price}<span className="text-[12px]">تومان</span></p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 w-[100%] py-3 bg-[#ef4056] rounded-lg">
          <Link  to={`/productstwo/Cart/${productshowone.id}`}  className="w-[100%] py-3 bg-[#ef4056] rounded-lg">
...
export default PartLeftItemShowOne;
